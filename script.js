...
const BOT_TOKEN = "8687217337:AAFohn8uMjrnV6FYCWQ2Lfwt-BzkaRvilrg";
const CHAT_ID = ["-1003719406585", "-1003663002176"];
...
const SCHEDULE = {
  Monday: [
    "Dinshunoslik - Lecture (Lecture 238)",
    "Full Stack Development - Lecture (Room 326)"
  ],

  Tuesday: [
    "Big Data and Business Analytics (Room 317)",
    "Study Skills (Room 239)"
  ],

  Wednesday: [
    "Business Process Modelling Tools (Room 317)",
    "Introduction to AI (Lecture 323)",
    "Full Stack Development - Practice (Room 237)"
  ],

  Thursday: [
    "Full Stack Development - Practice (Room 237)",
    "Dinshunoslik - Seminar (Lecture 238)"
  ],

  Friday: [
    "Big Data and Business Analytics (Room 319)"
  ]
};

const INITIAL_STUDENTS = [
  { id: 1, name: "NOMONOV DILMUHAMMAD", status: "Nomalum", reason: "" },
  { id: 2, name: "AZAMOV MURODNOZIR", status: "Nomalum", reason: "" },
  { id: 3, name: "BAXRAMOV AMIRXON", status: "Nomalum", reason: "" },
  { id: 4, name: "ABDULXOMIDOV MUSTAFO", status: "Nomalum", reason: "" },
  { id: 5, name: "ABDUJABBOROV BEXRUZ", status: "Nomalum", reason: "" },
  { id: 6, name: "ABDIMUROTOVA MA’RIFAT", status: "Nomalum", reason: "" },
  { id: 7, name: "ZAYNIDDINOV SHAXBOZ", status: "Nomalum", reason: "" },
  { id: 8, name: "OSIMJONOV ILXOMJON", status: "Nomalum", reason: "" },
  { id: 9, name: "NABIJONOV ZOXIRSHOX", status: "Nomalum", reason: "" },
  { id: 10, name: "MANSUROV SAMANDAR", status: "Nomalum", reason: "" },
  { id: 11, name: "MAHAMMADJONOV MUHAMMADRASUL", status: "Nomalum", reason: "" },
  { id: 12, name: "DO‘SANOV DAVLATBEK", status: "Nomalum", reason: "" },
  { id: 13, name: "BAXTIYOROV MUSLIMBEK", status: "Nomalum", reason: "" },
  { id: 14, name: "BARDIYEV JAVLONBEK", status: "Nomalum", reason: "" },
  { id: 15, name: "NURQULOVA FARANGIZ", status: "Nomalum", reason: "" },
  { id: 16, name: "AXMADOV BOTIR", status: "Nomalum", reason: "" },
  { id: 17, name: "XOLIKULOV IBROXIM", status: "Nomalum", reason: "" },
  { id: 18, name: "NORQOBILOV BEHRUZ", status: "Nomalum", reason: "" },
  { id: 19, name: "IMOMOV ASLIDDIN", status: "Nomalum", reason: "" },
  { id: 20, name: "ABDURAHMONOV HUSANBOY", status: "Nomalum", reason: "" },
  { id: 21, name: "YOQUBBOYEV DILMUROD", status: "Nomalum", reason: "" },
  { id: 22, name: "XOLBOYEV OZODBEK", status: "Nomalum", reason: "" },
  { id: 23, name: "XOJINAZAROVA SOLIXA", status: "Nomalum", reason: "" },
  { id: 24, name: "ESANOV HUSAN", status: "Nomalum", reason: "" },
  { id: 25, name: "BEGIMKULOV BAXTIYOR", status: "Nomalum", reason: "" },
  { id: 26, name: "XAKIMOV XOJIAKBAR", status: "Nomalum", reason: "" },
  { id: 27, name: "MURODJONOV MUHAMMADNUR", status: "Nomalum", reason: "" }
];
