...
const INITIAL_STUDENTS = [
  { id: 1, name: "Yusubjanov Azimjon", status: "Nomalum", reason: "" },
  { id: 2, name: "Tolaganov Abduqodir", status: "Nomalum", reason: "" },
  { id: 3, name: "Aqilbekov Sherzod", status: "Nomalum", reason: "" },
  { id: 4, name: "Abduraximov Ramazon", status: "Nomalum", reason: "" },
  { id: 5, name: "Raximjanov Shoxrux", status: "Nomalum", reason: "" },
  { id: 6, name: "Nuraliyev Shohjaxon", status: "Nomalum", reason: "" },
  { id: 7, name: "Kabilov Shuxrat", status: "Nomalum", reason: "" },
  { id: 8, name: "Ilhomov Umrbek", status: "Nomalum", reason: "" },
  { id: 9, name: "Xojiyev Ahmadjon", status: "Nomalum", reason: "" },
  { id: 10, name: "Kadirov Saidayubxon", status: "Nomalum", reason: "" },
  { id: 11, name: "Ibragimov Nusratillo", status: "Nomalum", reason: "" },
  { id: 12, name: "Mamadaminov Sardor", status: "Nomalum", reason: "" },
  { id: 13, name: "Ubbiev Paraxat", status: "Nomalum", reason: "" },
  { id: 14, name: "Allijanov Ayubxon", status: "Nomalum", reason: "" },
  { id: 15, name: "Xudayberganov Bekpolat", status: "Nomalum", reason: "" },
  { id: 16, name: "Xoshimjonov Asadbek", status: "Nomalum", reason: "" },
  { id: 17, name: "Omonov Xayotbek", status: "Nomalum", reason: "" },
  { id: 18, name: "Rashidov Abdurazoq", status: "Nomalum", reason: "" },
  { id: 19, name: "Mutalipov Dostonbek", status: "Nomalum", reason: "" }
];
